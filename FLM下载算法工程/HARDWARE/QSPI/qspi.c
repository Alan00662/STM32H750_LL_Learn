...
u8 QSPI_Init(void)
{
	...
	GPIO_Set(GPIOC,1<<11,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_HIGH,GPIO_PUPD_PU);	//PC11复用功能输出	
		
	GPIO_Set(GPIOE,0XF<<7,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_HIGH,GPIO_PUPD_PU);	//PF6~9复用功能输出	
	GPIO_Set(GPIOE,0XF<<8,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_HIGH,GPIO_PUPD_PU);	//PF6~9复用功能输出	
	GPIO_Set(GPIOE,0XF<<9,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_HIGH,GPIO_PUPD_PU);	//PF6~9复用功能输出	
	GPIO_Set(GPIOE,0XF<<10,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_HIGH,GPIO_PUPD_PU);	//PF6~9复用功能输出
	
	
  GPIO_AF_Set(GPIOB,2,9);		//PB2,AF9
 	GPIO_AF_Set(GPIOC,11,9);	//PB6,AF10
	
 	GPIO_AF_Set(GPIOE,7,10);		//PF7,AF9
 	GPIO_AF_Set(GPIOE,8,10);	//PF8,AF10
 	GPIO_AF_Set(GPIOE,9,10);	//PF9,AF10
	GPIO_AF_Set(GPIOE,10,10);		//PF6,AF9 
