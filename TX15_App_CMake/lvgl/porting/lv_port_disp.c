...
uint32_t FrameBuffer=0xD0000000;
/**********************
 *      MACROS
 **********************/
...
//    lv_display_set_buffers(disp, buf_3_1, buf_3_2, sizeof(buf_3_1), LV_DISPLAY_RENDER_MODE_DIRECT);
    ...
    LV_ATTRIBUTE_MEM_ALIGN
    static uint8_t buf_2_1[MY_DISP_HOR_RES * 160 * 2];

    LV_ATTRIBUTE_MEM_ALIGN
    static uint8_t buf_2_2[MY_DISP_HOR_RES * 160 * 2];
...
{
    /*You code here*/
	// memset((uint8_t*)0xD0000000,0x0000,480*320*2);				//开机清屏，全黑
}
