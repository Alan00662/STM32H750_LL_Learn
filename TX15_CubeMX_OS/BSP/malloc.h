...
#define MEM2_MAX_SIZE           61564 * 1024                    /* 最大管理内存61564K,外扩SDRAM总共64MB,LTDC占了2MB,还剩62MB. */
#define MEM2_ALLOC_TABLE_SIZE   MEM2_MAX_SIZE / MEM2_BLOCK_SIZE /* 内存表大小 */

/* mem3内存参数设定.mem3是H7内部的SRAM1+SRAM2内存 */
#define MEM3_BLOCK_SIZE         64                              /* 内存块大小为64字节 */
#define MEM3_MAX_SIZE           248 * 1024                      /* 最大管理内存248K,H7的SRAM1+SRAM2共256KB */
#define MEM3_ALLOC_TABLE_SIZE   MEM3_MAX_SIZE/MEM3_BLOCK_SIZE   /* 内存表大小 */

/* mem4内存参数设定.mem4是H7内部的SRAM4内存 */
#define MEM4_BLOCK_SIZE         64                              /* 内存块大小为64字节 */
#define MEM4_MAX_SIZE           62 * 1024                       /* 最大管理内存62K,H7的SRAM4共64KB */
...
#define MEM5_MAX_SIZE           124 * 1024                      /* 最大管理内存124K,H7的DTCM共128KB */
...
#define MEM6_MAX_SIZE           62 * 1024                       /* 最大管理内存62K,H7的ITCM共64KB */
