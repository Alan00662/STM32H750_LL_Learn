...
/*I2C引脚*/
#define GTP_I2C                          I2C4
#define GTP_I2C_CLK_ENABLE()             __HAL_RCC_I2C4_CLK_ENABLE()
#define GTP_I2C_CLK_INIT				 RCC_APB1PeriphClockCmd	

#define GTP_I2C_SCL_PIN                  GPIO_PIN_12                 
#define GTP_I2C_SCL_GPIO_PORT            GPIOD                       
#define GTP_I2C_SCL_GPIO_CLK_ENABLE()    __HAL_RCC_GPIOD_CLK_ENABLE()
#define GTP_I2C_SCL_AF                   GPIO_AF4_I2C4

#define GTP_I2C_SDA_PIN                  GPIO_PIN_13                  
#define GTP_I2C_SDA_GPIO_PORT            GPIOD                     
#define GTP_I2C_SDA_GPIO_CLK_ENABLE()    __HAL_RCC_GPIOD_CLK_ENABLE()
#define GTP_I2C_SDA_AF                   GPIO_AF4_I2C4

/*复位引脚*/
#define GTP_RST_GPIO_PORT                GPIOJ
#define GTP_RST_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOJ_CLK_ENABLE()
#define GTP_RST_GPIO_PIN                 GPIO_PIN_13
/*中断引脚*/
#define GTP_INT_GPIO_PORT                GPIOE
#define GTP_INT_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOE_CLK_ENABLE()
#define GTP_INT_GPIO_PIN                 GPIO_PIN_2
#define GTP_INT_EXTI_IRQ                 EXTI2_IRQn
/*中断服务函数*/
#define GTP_IRQHandler                   EXTI2_IRQHandler
