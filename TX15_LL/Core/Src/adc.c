...
void MX_ADC3_Init(void)
{
  ...
  */
  ...
  /** Configure Regular Channel
  */
  LL_ADC_REG_SetSequencerRanks(ADC3, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_14);
  LL_ADC_SetChannelSamplingTime(ADC3, LL_ADC_CHANNEL_14, LL_ADC_SAMPLINGTIME_1CYCLE_5);
