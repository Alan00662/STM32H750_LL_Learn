 ...
 * 2. 设置 DEBUG_OUTPUT_MODE 选择输出方式（0=LCD，1=串口，可扩展）(只推荐用串口！！！)
...
#define DEBUG_OUTPUT_MODE 0 /*!< 调试输出模式：0=LCD，1=串口，2=串口重定向printf，3=预留扩展 */
...
#define DEBUG_ERROR(...) Debug_Error(__FILE__, __FUNCTION__, __LINE__, __VA_ARGS__)
#endif
