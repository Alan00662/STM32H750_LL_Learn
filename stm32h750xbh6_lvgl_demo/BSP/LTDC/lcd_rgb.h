 ...
 *                             配置是否用外部字库
 ******************************************************************************/
#define USE_FLASH_FONT_RGB /*!< 定义了：使用Flash字库, 注释后：使用内置取模字库 */
 ...
 */
#if (RGB_ColorMode_0 == LTDC_PIXEL_FORMAT_RGB565 || RGB_ColorMode_0 == LTDC_PIXEL_FORMAT_ARGB1555 || RGB_ColorMode_0 == LTDC_PIXEL_FORMAT_ARGB4444)
...
#if (RGB_ColorMode_1 == LTDC_PIXEL_FORMAT_RGB565 || RGB_ColorMode_1 == LTDC_PIXEL_FORMAT_ARGB1555 || RGB_ColorMode_1 == LTDC_PIXEL_FORMAT_ARGB4444)
...
#define RGB_LCD_MemoryAdd_OFFSET RGB_LCD_Width * RGB_LCD_Height * RGB_BytesPerPixel_0 /*!< Layer1显存偏移地址 */
...
#define RGB_LCD_Backlight_OFF HAL_GPIO_WritePin(RGB_LCD_Backlight_PORT, RGB_LCD_Backlight_PIN, GPIO_PIN_RESET); /*!< 关闭背光 */
#define RGB_LCD_Backlight_ON HAL_GPIO_WritePin(RGB_LCD_Backlight_PORT, RGB_LCD_Backlight_PIN, GPIO_PIN_SET);	/*!< 开启背光 */
