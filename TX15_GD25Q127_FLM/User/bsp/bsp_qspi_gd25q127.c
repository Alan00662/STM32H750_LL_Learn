...
/*
*********************************************************************************************************
*    函 数 名: bsp_InitQSPI_W25Q128
*    功能说明: QSPI Flash硬件初始化，配置基本参数
*    形    参: 无
*    返 回 值: 0 表示成功， 1 表示失败
*********************************************************************************************************
*/
uint8_t bsp_InitQSPI_W25Q128(void)
{
    uint32_t i;
    char *p;
    ...
    /* 设置时钟速度，QSPI clock = 240MHz / (ClockPrescaler+1) = 120MHz  W25Q128JV这款芯片最高支持133MHZ */
//    hqspi.Init.ClockPrescaler     = 2-1;//2分频
		hqspi.Init.ClockPrescaler     = 2;//2分频
    /* 设置FIFO阀值，范围1 - 32 */
